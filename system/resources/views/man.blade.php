	 ...
	 <div class="container">
		 <div class="header-left">
			 <div class="top-menu">
				 ...
				 <li class="active"><a href="{{url('man')}}">MAN</a></li>			 
				 </ul>
			 </div>
		 </div>
		 <div class="logo">
			 <a href="{{url('home')}}"><img src="{{url('public')}}/images/logo.png" alt=""/></a>
		 </div>
			 ...
			 <div class="fashion-section">
				 <div class="fashion-grid1">
					 <div class="col-md-4 fashion-grid">
						 <a href="{{url('single')}}"><img src="{{url('public')}}/images/m4.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
						 ...
						 <div class="fashion-view"><span></span>
									<div class="clearfix"></div>
								 <h4><a href="{{url('single')}}">Quick View</a></h4>
						 </div>
					 </div>
					 <div class="col-md-4 fashion-grid">
						 <a href="{{url('single')}}"><img src="{{url('public')}}/images/m2.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="{{url('single')}}"><img src="{{url('public')}}/images/m3.jpg" alt=""/>
							 <div class="product not-avaliable">
								 <h3>PRODUCT NAME</h3>
								 <p><del><span></span> 176.00 &euro;</del></p>
							 </div>
						 </a>
						 <div class="fashion-view"><span></span>
									<div class="clearfix"></div>
								 <h4 class="sold-out"><a href="{{url('single')}}"><del>Sold Out</del></a></h4>
						 </div>
					 </div>
					 <div class="clearfix"></div>
				 </div>
				 <div class="fashion-grid2">
					 <div class="col-md-4 fashion-grid">
						 <a href="{{url('single')}}"><img src="{{url('public')}}/images/m1.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="{{url('single')}}"><img class="img-responsive zoom-img" src="{{url('public')}}/images/m6.jpg" alt=""/>
							 <div class="product not-avaliable">
								 <h3>PRODUCT NAME</h3>
								 <p><del><span></span> 176.00 &euro;</del></p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="{{url('single')}}"><img src="{{url('public')}}/images/m5.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
