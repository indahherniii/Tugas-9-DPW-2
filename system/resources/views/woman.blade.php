			 ...
			 <div class="fashion-section">
				 <div class="fashion-grid1">
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/g1.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/g2.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/g3.jpg" alt=""/>
						 ...
						 <div class="fashion-view"><span></span>
									<div class="clearfix"></div>
								 <h4 class="sold-out"><a href="single.html"><del>Sold Out</del></a></h4>
						 </div>
					 </div>
					 <div class="clearfix"></div>
				 </div>
				 <div class="fashion-grid2">
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/g4.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/g5.jpg" alt=""/>
							 <div class="product not-avaliable">
								 <h3>PRODUCT NAME</h3>
								 <p><del><span></span> 176.00 &euro;</del></p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/g6.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
